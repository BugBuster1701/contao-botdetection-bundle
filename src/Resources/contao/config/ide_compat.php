...
namespace BotDetection {
    class ModuleBotDetection extends \BugBuster\BotDetection\ModuleBotDetection {}
    ...
    class CheckBotReferrer extends \BugBuster\BotDetection\CheckBotReferrer {}
    class CheckBotIp extends \BugBuster\BotDetection\CheckBotIp {}
}
